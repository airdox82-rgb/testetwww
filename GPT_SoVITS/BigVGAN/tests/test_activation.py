...
def test_anti_alias_activation():
    ...
    fused_anti_alias_activation = activation1d.Activation1d(activation=Snake(10), fused=True) # Removed .cuda()
    fused_activation_output = fused_anti_alias_activation(data)

    torch_anti_alias_activation = activation1d.Activation1d(activation=Snake(10), fused=False) # Removed .cuda()
